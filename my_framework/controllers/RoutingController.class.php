...
class RoutingController extends RoutingModel
{
    public function defaultAction()
    {
        $this->isLogged();
        $list = ['routing/get'     => 'Liste de la table Routing',
                 'routing/add'     => 'Ajouter dans la table Routing',
                 'routing/replace' => 'Remplacer dans la table Routing',
                 'routing/remove'  => 'Suprimer dans la table Routing'];
        $link = "";
